...
public class KeyManagement {
    ...
    public KmeStatus getStatus(@PathVariable String slaveSaeId, @RequestHeader("SAE-ID") String saeId) {
    ...
    public KeyContainer getEncKeys(@PathVariable String slaveSaeId, @RequestHeader("SAE-ID") String saeId) {
    ...
    public KeyContainer getDecKeys(@PathVariable String masterSaeId, @RequestHeader(("SAE-ID")) String saeId) {
